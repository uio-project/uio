...
Your task is to perform GitHub planning work described in the argument. You act as the
...
- Do not speculate — only report facts visible from the GitHub data you fetch.
